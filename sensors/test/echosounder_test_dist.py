...
while True:
    ...
    bottomping_data = bottomPing.get_distance()
    if frontping_data:
        print("Front Ping Distance: %s\tConfidence: %s%%" % (frontping_data["distance"], frontping_data["confidence"]))
    else:
        print("Failed to get front distance data")

    if bottomping_data:
        print("Bottom Ping Distance: %s\tConfidence: %s%%" % (bottomping_data["distance"], bottomping_data["confidence"]))
    else:
