...
### Thruster Setup ###
BPH = PWM(Pin(0), freq=200)  # Bow-Port-Heave
BSH = PWM(Pin(2), freq=200)  # Bow-Starboard-Heave
SH  = PWM(Pin(4), freq=200)  # Stern-Heave
Y   = PWM(Pin(6), freq=200)  # Yaw
PS  = PWM(Pin(8), freq=200)  # Port-Surge
SS  = PWM(Pin(14), freq=200) # Starboard-Surge
