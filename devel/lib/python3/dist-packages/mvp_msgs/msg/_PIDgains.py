...
"""autogenerated by genpy from mvp_msgs/PIDgains.msg. Do not edit."""
import codecs
import sys
...
class PIDgains(genpy.Message):
  _md5sum = "64020c6ebba7ed9dc090c3163510a872"
  _type = "mvp_msgs/PIDgains"
...
float64 k_i_max
float64 k_i_min"""
  __slots__ = ['kp','ki','kd','k_i_max','k_i_min']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kd is None:
        self.kd = 0.
      if self.k_i_max is None:
        self.k_i_max = 0.
      if self.k_i_min is None:
        self.k_i_min = 0.
    else:
      self.kp = 0.
      self.ki = 0.
