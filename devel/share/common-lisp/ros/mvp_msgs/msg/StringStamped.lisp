...
(cl:defmethod cl:initialize-instance :after ((m <StringStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvp_msgs-msg:<StringStamped> is deprecated: use mvp_msgs-msg:StringStamped instead.")))
