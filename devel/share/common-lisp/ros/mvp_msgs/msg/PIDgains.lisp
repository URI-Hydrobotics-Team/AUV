...
(cl:defmethod cl:initialize-instance :after ((m <PIDgains>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PIDgains)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvp_msgs-msg:<PIDgains> is deprecated: use mvp_msgs-msg:PIDgains instead.")))

(cl:ensure-generic-function 'kp-val :lambda-list '(m))
(cl:defmethod kp-val ((m <PIDgains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_msgs-msg:kp-val is deprecated.  Use mvp_msgs-msg:kp instead.")
  (kp m))

(cl:ensure-generic-function 'ki-val :lambda-list '(m))
(cl:defmethod ki-val ((m <PIDgains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_msgs-msg:ki-val is deprecated.  Use mvp_msgs-msg:ki instead.")
  (ki m))

(cl:ensure-generic-function 'kd-val :lambda-list '(m))
(cl:defmethod kd-val ((m <PIDgains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_msgs-msg:kd-val is deprecated.  Use mvp_msgs-msg:kd instead.")
  (kd m))

(cl:ensure-generic-function 'k_i_max-val :lambda-list '(m))
(cl:defmethod k_i_max-val ((m <PIDgains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_msgs-msg:k_i_max-val is deprecated.  Use mvp_msgs-msg:k_i_max instead.")
  (k_i_max m))

(cl:ensure-generic-function 'k_i_min-val :lambda-list '(m))
(cl:defmethod k_i_min-val ((m <PIDgains>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvp_msgs-msg:k_i_min-val is deprecated.  Use mvp_msgs-msg:k_i_min instead.")
  (k_i_min m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PIDgains>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'kd))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'k_i_max))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'k_i_min))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PIDgains>) istream)
  "Deserializes a message object of type '<PIDgains>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'k_i_max) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'k_i_min) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PIDgains>)))
  ...
  "64020c6ebba7ed9dc090c3163510a872")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PIDgains)))
  "Returns md5sum for a message object of type 'PIDgains"
  "64020c6ebba7ed9dc090c3163510a872")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PIDgains>))
  ...
  (cl:list 'PIDgains
    ...
    (cl:cons ':ki (ki msg))
    (cl:cons ':kd (kd msg))
    (cl:cons ':k_i_max (k_i_max msg))
    (cl:cons ':k_i_min (k_i_min msg))
))
