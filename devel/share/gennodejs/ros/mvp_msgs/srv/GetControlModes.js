...
class GetControlModesRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetControlModesRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetControlModesRequest
    let len;
    let data = new GetControlModesRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'mvp_msgs/GetControlModesRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetControlModesRequest(null);
    return resolved;
    }
};

class GetControlModesResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.modes = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetControlModesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetControlModesResponse
    let len;
    let data = new GetControlModesResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetControlModesResponse(null);
...
module.exports = {
  Request: GetControlModesRequest,
  Response: GetControlModesResponse,
  md5sum() { return '603519323f79819b7761d3e2017e75dd'; },
  datatype() { return 'mvp_msgs/GetControlModes'; }
};
