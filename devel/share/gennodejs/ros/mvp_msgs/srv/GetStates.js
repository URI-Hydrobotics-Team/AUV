...
class GetStatesRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetStatesRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetStatesRequest
    let len;
    let data = new GetStatesRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetStatesRequest(null);
    return resolved;
    }
};
...
class GetStatesResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetStatesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetStatesResponse
    let len;
    let data = new GetStatesResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mvp_msgs/GetStatesResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetStatesResponse(null);
...
module.exports = {
  ...
  md5sum() { return '7fb91daf3e8086897a6eccc9f862d3a8'; },
  datatype() { return 'mvp_msgs/GetStates'; }
};
