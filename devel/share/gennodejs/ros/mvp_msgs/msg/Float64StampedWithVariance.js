...
class Float64StampedWithVariance {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Float64StampedWithVariance(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Float64StampedWithVariance(null);
...
module.exports = Float64StampedWithVariance;
